// Code generated by 'yaegi extract github.com/blakearnold/xo/types'. DO NOT EDIT.

package internal

import (
	"github.com/blakearnold/xo/types"
	"reflect"
)

func init() {
	Symbols["github.com/blakearnold/xo/types/types"] = map[string]reflect.Value{
